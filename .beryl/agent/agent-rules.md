...
introductory undergraduate software-engineering course. Students use it as the
starting point for their own projects.

Unless the user says otherwise, assist a student working in this repository.
Adapt when the user identifies themselves as an instructor or another project
stakeholder.
