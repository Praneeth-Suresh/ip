...
| --- | --- | --- | --- | --- |
| Personal Assistant Chatbot | `Duke` | The application that helps one person keep track of various things. | The exact supported things are not specified yet. | Generic `app` |
